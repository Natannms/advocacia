    ...
    <section class="text-gray-400 bg-gray-900 body-font py-20">
        <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            ...
            <p class="mb-8 leading-relaxed">Nosso escritório surgiu a partir da unidade de competências e valores dos nossos sócios que, juntos, pretendem oferecer serviços jurídicos de excelência com foco na apresentação de soluções jurídicas.
            </p>
